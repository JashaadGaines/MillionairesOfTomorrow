...
<body>
  ...
  <div class="container">
    ...
    <div id="documentation">
      ...
      <p id="each">
        <b class="imageBack">each</b><code>_.each(list, iterator, [context])</code>
...
=&gt; alerts each number value in turn...</pre>
      ...
      <p id="map">
        <b class="imageBack">map</b><code>_.map(list, iterator, [context])</code>
...
=&gt; [3, 6, 9]</pre>
      ...
      <p id="reduce">
        <b class="imageBack">reduce</b><code>_.reduce(list, iterator, memo, [context])</code>
...
=&gt; 6
      ...
      <p id="reduceRight">
        <b class="imageBack">reduceRight</b><code>_.reduceRight(list, iterator, memo, [context])</code>
...
=&gt; [4, 5, 2, 3, 0, 1]
      ...
      <p id="find">
        <b class="imageBack">find</b><code>_.find(list, iterator, [context])</code>
...
=&gt; 2
      ...
      <p id="filter">
        <b class="imageBack">filter</b><code>_.filter(list, iterator, [context])</code>
...
=&gt; [2, 4, 6]
      ...
      <p id="where">
        <b class="imageBack">where</b><code>_.where(list, properties)</code>
        <br />
        Looks through each value in the <b>list</b>, returning an array of all
...
=&gt; [{title: "Cymbeline", author: "Shakespeare", year: 1611},
    {title: "The Tempest", author: "Shakespeare", year: 1611}]
      ...
      <p id="findWhere">
        <b class="imageBack">findWhere</b><code>_.findWhere(list, properties)</code>
        <br />
...
=&gt; {year: 1918, newsroom: "The New York Times",
  ...
  conduct of the war."}
      ...
      <p id="reject">
        <b class="imageBack">reject</b><code>_.reject(list, iterator, [context])</code>
        <br />
...
=&gt; [1, 3, 5]
      ...
      <p id="every">
        <b class="imageBack">every</b><code>_.every(list, iterator, [context])</code>
...
=&gt; false
      ...
      <p id="some">
        <b class="imageBack">some</b><code>_.some(list, [iterator], [context])</code>
...
=&gt; true
      ...
      <p id="contains">
        <b class="imageBack">contains</b><code>_.contains(list, value)</code>
...
=&gt; true
      ...
      <p id="invoke">
        <b class="imageBack">invoke</b><code>_.invoke(list, methodName, [*arguments])</code>
        <br />
...
=&gt; [[1, 5, 7], [1, 2, 3]]
      ...
      <p id="pluck">
        <b class="imageBack">pluck</b><code>_.pluck(list, propertyName)</code>
        <br />
...
=&gt; ["moe", "larry", "curly"]
      ...
      <p id="max">
        <b class="imageBack">max</b><code>_.max(list, [iterator], [context])</code>
        <br />
...
=&gt; {name : 'curly', age : 60};
      ...
      <p id="min">
        <b class="imageBack">min</b><code>_.min(list, [iterator], [context])</code>
        <br />
...
=&gt; 2
      ...
      <p id="sortBy">
        <b class="imageBack">sortBy</b><code>_.sortBy(list, iterator, [context])</code>
        <br />
...
=&gt; [5, 4, 6, 3, 1, 2]
      ...
      <p id="groupBy">
        <b class="imageBack">groupBy</b><code>_.groupBy(list, iterator, [context])</code>
        <br />
...
=&gt; {3: ["one", "two"], 5: ["three"]}
      ...
      <p id="countBy">
        <b class="imageBack">countBy</b><code>_.countBy(list, iterator, [context])</code>
        <br />
...
=&gt; {odd: 3, even: 2}
      ...
      <p id="shuffle">
        <b class="imageBack">shuffle</b><code>_.shuffle(list)</code>
        <br />
...
=&gt; [4, 1, 6, 3, 5, 2]
      ...
      <p id="toArray">
        <b class="imageBack">toArray</b><code>_.toArray(list)</code>
        <br />
...
=&gt; [2, 3, 4]
      ...
      <p id="size">
        <b class="imageBack">size</b><code>_.size(list)</code>
        <br />
...
=&gt; 3
      ...
      <p id="first">
        <b class="imageBack">first</b><code>_.first(array, [n])</code>
...
=&gt; 5
      ...
      <p id="initial">
        <b class="imageBack">initial</b><code>_.initial(array, [n])</code>
        <br />
...
=&gt; [5, 4, 3, 2]
      ...
      <p id="last">
        <b class="imageBack">last</b><code>_.last(array, [n])</code>
        <br />
...
=&gt; 1
      ...
      <p id="rest">
        <b class="imageBack">rest</b><code>_.rest(array, [index])</code>
...
=&gt; [4, 3, 2, 1]
      ...
      <p id="compact">
        <b class="imageBack">compact</b><code>_.compact(array)</code>
        <br />
...
=&gt; [1, 2, 3]
      ...
      <p id="flatten">
        <b class="imageBack">flatten</b><code>_.flatten(array, [shallow])</code>
        <br />
...
=&gt; [1, 2, 3, [[4]]];
      ...
      <p id="without">
        <b class="imageBack">without</b><code>_.without(array, [*values])</code>
        <br />
...
=&gt; [2, 3, 4]
      ...
      <p id="union">
        <b class="imageBack">union</b><code>_.union(*arrays)</code>
        <br />
...
=&gt; [1, 2, 3, 101, 10]
      ...
      <p id="intersection">
        <b class="imageBack">intersection</b><code>_.intersection(*arrays)</code>
        <br />
...
=&gt; [1, 2]
      ...
      <p id="difference">
        <b class="imageBack">difference</b><code>_.difference(array, *others)</code>
        <br />
...
=&gt; [1, 3, 4]
      ...
      <p id="uniq">
        <b class="imageBack">uniq</b><code>_.uniq(array, [isSorted], [iterator])</code>
...
=&gt; [1, 2, 3, 4]
      ...
      <p id="zip">
        <b class="imageBack">zip</b><code>_.zip(*arrays)</code>
        <br />
...
=&gt; [["moe", 30, true], ["larry", 40, false], ["curly", 50, false]]
      ...
      <p id="object">
        <b class="imageBack">object</b><code>_.object(list, [values])</code>
        <br />
...
=&gt; {moe: 30, larry: 40, curly: 50}
      ...
      <p id="indexOf">
        <b class="imageBack">indexOf</b><code>_.indexOf(array, value, [isSorted])</code>
        <br />
...
=&gt; 1
      ...
      <p id="lastIndexOf">
        <b class="imageBack">lastIndexOf</b><code>_.lastIndexOf(array, value, [fromIndex])</code>
        <br />
...
=&gt; 4
      ...
      <p id="sortedIndex">
        <b class="imageBack">sortedIndex</b><code>_.sortedIndex(list, value, [iterator], [context])</code>
        <br />
...
=&gt; 3
      ...
      <p id="range">
        <b class="imageBack">range</b><code>_.range([start], stop, [step])</code>
        <br />
...
=&gt; []
      ...
      <p id="bind">
        <b class="imageBack">bind</b><code>_.bind(function, object, [*arguments])</code>
        <br />
...
=&gt; 'hi: moe'
      ...
      <p id="bindAll">
        <b class="imageBack">bindAll</b><code>_.bindAll(object, [*methodNames])</code>
        <br />
...
=&gt; When the button is clicked, this.label will have the correct value...
      ...
      <p id="partial">
        <b class="imageBack">partial</b><code>_.partial(function, [*arguments])</code>
        <br />
...
=&gt; 15
      ...
      <p id="memoize">
        <b class="imageBack">memoize</b><code>_.memoize(function, [hashFunction])</code>
        <br />
...
var fibonacci = _.memoize(function(n) {
  return n &lt; 2 ? n : fibonacci(n - 1) + fibonacci(n - 2);
      ...
      <p id="delay">
        <b class="imageBack">delay</b><code>_.delay(function, wait, [*arguments])</code>
        <br />
...
=&gt; 'logged later' // Appears after one second.
      ...
      <p id="defer">
        <b class="imageBack">defer</b><code>_.defer(function, [*arguments])</code>
        <br />
...
// Returns from the function before the alert runs.
      ...
      <p id="throttle">
        <b class="imageBack">throttle</b><code>_.throttle(function, wait)</code>
        <br />
...
$(window).scroll(throttled);
      ...
      <p id="debounce">
        <b class="imageBack">debounce</b><code>_.debounce(function, wait, [immediate])</code>
        <br />
...
$(window).resize(lazyLayout);
      ...
      <p id="once">
        <b class="imageBack">once</b><code>_.once(function)</code>
        <br />
...
// Application is only created once.
      ...
      <p id="after">
        <b class="imageBack">after</b><code>_.after(count, function)</code>
        <br />
...
// renderNotes is run once, after all notes have saved.
      ...
      <p id="wrap">
        <b class="imageBack">wrap</b><code>_.wrap(function, wrapper)</code>
        <br />
...
=&gt; 'before, hello: moe, after'
      ...
      <p id="compose">
        <b class="imageBack">compose</b><code>_.compose(*functions)</code>
        <br />
...
=&gt; 'hi: moe!'
      ...
      <p id="keys">
        <b class="imageBack">keys</b><code>_.keys(object)</code>
        <br />
...
=&gt; ["one", "two", "three"]
      ...
      <p id="values">
        <b class="imageBack">values</b><code>_.values(object)</code>
        <br />
...
=&gt; [1, 2, 3]
      ...
      <p id="pairs">
        <b class="imageBack">pairs</b><code>_.pairs(object)</code>
        <br />
...
=&gt; [["one", 1], ["two", 2], ["three", 3]]
      ...
      <p id="invert">
        <b class="imageBack">invert</b><code>_.invert(object)</code>
        <br />
...
=&gt; {Moses: "Moe", Louis: "Larry", Jerome: "Curly"};
      ...
      <p id="object-functions">
        <b class="imageBack">functions</b><code>_.functions(object)</code>
...
=&gt; ["all", "any", "bind", "bindAll", "clone", "compact", "compose" ...
      ...
      <p id="extend">
        <b class="imageBack">extend</b><code>_.extend(destination, *sources)</code>
        <br />
...
=&gt; {name : 'moe', age : 50}
      ...
      <p id="pick">
        <b class="imageBack">pick</b><code>_.pick(object, *keys)</code>
        <br />
...
=&gt; {name : 'moe', age : 50}
      ...
      <p id="omit">
        <b class="imageBack">omit</b><code>_.omit(object, *keys)</code>
        <br />
...
=&gt; {name : 'moe', age : 50}
      ...
      <p id="defaults">
        <b class="imageBack">defaults</b><code>_.defaults(object, *defaults)</code>
        <br />
...
=&gt; {flavor : "chocolate", sprinkles : "lots"}
      ...
      <p id="clone">
        <b class="imageBack">clone</b><code>_.clone(object)</code>
        <br />
...
=&gt; {name : 'moe'};
      ...
      <p id="tap">
        <b class="imageBack">tap</b><code>_.tap(object, interceptor)</code>
        <br />
...
=&gt; [4, 40000]
      ...
      <p id="has">
        <b class="imageBack">has</b><code>_.has(object, key)</code>
        <br />
...
=&gt; true
      ...
      <p id="isEqual">
        <b class="imageBack">isEqual</b><code>_.isEqual(object, other)</code>
        <br />
...
=&gt; true
      ...
      <p id="isEmpty">
        <b class="imageBack">isEmpty</b><code>_.isEmpty(object)</code>
        <br />
...
=&gt; true
      ...
      <p id="isElement">
        <b class="imageBack">isElement</b><code>_.isElement(object)</code>
        <br />
...
=&gt; true
      ...
      <p id="isArray">
        <b class="imageBack">isArray</b><code>_.isArray(object)</code>
        <br />
...
=&gt; true
      ...
      <p id="isObject">
        <b class="imageBack">isObject</b><code>_.isObject(value)</code>
        <br />
...
=&gt; false
      ...
      <p id="isArguments">
        <b class="imageBack">isArguments</b><code>_.isArguments(object)</code>
        <br />
...
=&gt; false
      ...
      <p id="isFunction">
        <b class="imageBack">isFunction</b><code>_.isFunction(object)</code>
        <br />
...
=&gt; true
      ...
      <p id="isString">
        <b class="imageBack">isString</b><code>_.isString(object)</code>
        <br />
...
=&gt; true
      ...
      <p id="isNumber">
        <b class="imageBack">isNumber</b><code>_.isNumber(object)</code>
        <br />
...
=&gt; true
      ...
      <p id="isFinite">
        <b class="imageBack">isFinite</b><code>_.isFinite(object)</code>
        <br />
...
=&gt; false
      ...
      <p id="isBoolean">
        <b class="imageBack">isBoolean</b><code>_.isBoolean(object)</code>
        <br />
...
=&gt; false
      ...
      <p id="isDate">
        <b class="imageBack">isDate</b><code>_.isDate(object)</code>
        <br />
...
=&gt; true
      ...
      <p id="isRegExp">
        <b class="imageBack">isRegExp</b><code>_.isRegExp(object)</code>
        <br />
...
=&gt; true
      ...
      <p id="isNaN">
        <b class="imageBack">isNaN</b><code>_.isNaN(object)</code>
        <br />
...
=&gt; false
      ...
      <p id="isNull">
        <b class="imageBack">isNull</b><code>_.isNull(object)</code>
        <br />
...
=&gt; false
      ...
      <p id="isUndefined">
        <b class="imageBack">isUndefined</b><code>_.isUndefined(value)</code>
        <br />
...
=&gt; true
      ...
      <p id="noConflict">
        <b class="imageBack">noConflict</b><code>_.noConflict()</code>
        <br />
...
var underscore = _.noConflict();</pre>
      ...
      <p id="identity">
        <b class="imageBack">identity</b><code>_.identity(value)</code>
        <br />
...
=&gt; true</pre>
      ...
      <p id="times">
        <b class="imageBack">times</b><code>_.times(n, iterator, [context])</code>
        <br />
...
_(3).times(function(n){ genie.grantWishNumber(n); });</pre>
      ...
      <p id="random">
        <b class="imageBack">random</b><code>_.random(min, max)</code>
        <br />
...
=&gt; 42</pre>
      ...
      <p id="mixin">
        <b class="imageBack">mixin</b><code>_.mixin(object)</code>
        <br />
...
=&gt; "Fabio"
      ...
      <p id="uniqueId">
        <b class="imageBack">uniqueId</b><code>_.uniqueId([prefix])</code>
        <br />
...
=&gt; 'contact_104'</pre>
      ...
      <p id="escape">
        <b class="imageBack">escape</b><code>_.escape(string)</code>
        <br />
...
=&gt; "Curly, Larry &amp;amp; Moe"</pre>
      ...
      <p id="unescape">
        <b class="imageBack">unescape</b><code>_.unescape(string)</code>
        <br />
...
=&gt; "Curly, Larry &amp; Moe"</pre>
      ...
      <p id="result">
        <b class="imageBack">result</b><code>_.result(object, property)</code>
        <br />
...
=&gt; "nonsense"</pre>
      ...
      <p id="template">
        <b class="imageBack">template</b><code>_.template(templateString, [data], [settings])</code>
        <br />
...
=&gt; {lumberjack : 2, all : 4, night : 2 ... }</pre>
      ...
      <p id="chain">
        <b class="imageBack">chain</b><code>_.chain(obj)</code>
        <br />
...
=&gt; "moe is 21"
      ...
      <p id="value">
        <b class="imageBack">value</b><code>_(obj).value()</code>
        <br />
...
=&gt; [1, 2, 3]
      ...
      <p>
        <b class="imageBack">1.4.4</b> &mdash; <small><i>Jan. 30, 2013</i></small> &mdash; <a href="https://github.com/documentcloud/underscore/compare/1.4.3...1.4.4">Diff</a><br />
        <ul>
          <li>
      ...
      <p>
        <b class="imageBack">1.4.3</b> &mdash; <small><i>Dec. 4, 2012</i></small> &mdash; <a href="https://github.com/documentcloud/underscore/compare/1.4.2...1.4.3">Diff</a><br />
        <ul>
          <li>
      ...
      <p>
        <b class="imageBack">1.4.2</b> &mdash; <small><i>Oct. 1, 2012</i></small> &mdash; <a href="https://github.com/documentcloud/underscore/compare/1.4.1...1.4.2">Diff</a><br />
        <ul>
          <li>
      ...
      <p>
        <b class="imageBack">1.4.1</b> &mdash; <small><i>Oct. 1, 2012</i></small> &mdash; <a href="https://github.com/documentcloud/underscore/compare/1.4.0...1.4.1">Diff</a><br />
        <ul>
          <li>
      ...
      <p>
        <b class="imageBack">1.4.0</b> &mdash; <small><i>Sept. 27, 2012</i></small>  &mdash; <a href="https://github.com/documentcloud/underscore/compare/1.3.3...1.4.0">Diff</a><br />
        <ul>
          <li>
      ...
      <p>
        <b class="imageBack">1.3.3</b> &mdash; <small><i>April 10, 2012</i></small><br />
        <ul>
          <li>
      ...
      <p>
        <b class="imageBack">1.3.1</b> &mdash; <small><i>Jan. 23, 2012</i></small><br />
        <ul>
          <li>
      ...
      <p>
        <b class="imageBack">1.3.0</b> &mdash; <small><i>Jan. 11, 2012</i></small><br />
        <ul>
          <li>
      ...
      <p>
        <b class="imageBack">1.2.4</b> &mdash; <small><i>Jan. 4, 2012</i></small><br />
        <ul>
          <li>
      ...
      <p>
        <b class="imageBack">1.2.3</b> &mdash; <small><i>Dec. 7, 2011</i></small><br />
        <ul>
          <li>
      ...
      <p>
        <b class="imageBack">1.2.2</b> &mdash; <small><i>Nov. 14, 2011</i></small><br />
        <ul>
          <li>
      ...
      <p>
        <b class="imageBack">1.2.1</b> &mdash; <small><i>Oct. 24, 2011</i></small><br />
        <ul>
          <li>
      ...
      <p>
        <b class="imageBack">1.2.0</b> &mdash; <small><i>Oct. 5, 2011</i></small><br />
        <ul>
          <li>
      ...
      <p>
        <b class="imageBack">1.1.7</b> &mdash; <small><i>July 13, 2011</i></small><br />
      ...
      <p>
        <b class="imageBack">1.1.6</b> &mdash; <small><i>April 18, 2011</i></small><br />
      ...
      <p>
        <b class="imageBack">1.1.5</b> &mdash; <small><i>Mar 20, 2011</i></small><br />
      ...
      <p>
        <b class="imageBack">1.1.4</b> &mdash; <small><i>Jan 9, 2011</i></small><br />
      ...
      <p>
        <b class="imageBack">1.1.3</b> &mdash; <small><i>Dec 1, 2010</i></small><br />
